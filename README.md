...
I'm a **Data Science & AI enthusiast** currently studying **Informatics Engineering**, spending most of my time turning messy datasets into models that actually mean something.

Right now I'm deep in:
- 🔍 Sharpening fundamentals in **Machine Learning & Deep Learning**
- 👁️ Playing with **Computer Vision** using OpenCV
- 📈 Getting comfortable with the full pipeline — from raw data to a trained model

I believe good data science isn't about fancy models, it's about **asking the right question first.**

</td>
<td width="40%" align="center">

<img src="https://media1.tenor.com/m/aXVFqv8KInAAAAAC/anime-frieren.gif" width="100%" alt="showcase gif"/>
